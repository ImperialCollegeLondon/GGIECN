...
digi_mean, digi_std = (0.485, 0.456, 0.406), (0.229, 0.224, 0.225)
transform = transforms.Compose([transforms.ToTensor(), transforms.Normalize(digi_mean, digi_std)])
...
def compute_metrics(preds, targets, ignore_label=255, num_classes=3, num_category=3):
